...
// Server Component gate — same pattern as app/online-competition/admin/page
// .tsx (shared password cookie, not the club's Firebase-Auth admin system).
export default async function OnlineCompetitionAdminAthletesPage() {
