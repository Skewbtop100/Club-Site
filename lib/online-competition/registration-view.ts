...
export function verificationNoticeCopy(
  ...
  if (status === 'pending') {
    return {
      ...
      body: 'Админ таны профайлыг шалгаж байна. Баталгаажих хүртэл туршилт хийх, тэмцээнд бүртгүүлэх боломжгүй.',
      action: 'Профайл харах →',
    };
  }
  if (status === 'rejected') {
    ...
    return {
      ...
      body: reason
        ? `Профайл баталгаажсангүй. Шалтгаан: ${reason}. Засаад дахин илгээнэ үү — баталгаажих хүртэл туршилт хийх, тэмцээнд бүртгүүлэх боломжгүй.`
        : 'Профайл баталгаажсангүй. Засаад дахин илгээнэ үү — баталгаажих хүртэл туршилт хийх, тэмцээнд бүртгүүлэх боломжгүй.',
      action: 'Профайл засах →',
    };
  }
  return {
    label: 'ПРОФАЙЛ БӨГЛӨӨГҮЙ',
    body: 'Тэмцээнд оролцохын тулд профайлаа бөглөж, админаар баталгаажуулна. Баталгаажих хүртэл туршилт хийх, тэмцээнд бүртгүүлэх боломжгүй.',
    action: 'Профайл бөглөх →',
  };
}
